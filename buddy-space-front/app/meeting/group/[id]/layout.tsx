...
import { GroupPermissionsProvider, useGroupPermissions } from "@/app/components/hooks/useGroupPermissions"

// 이 컴포넌트가 GroupPermissionsContext를 소비합니다.
function GroupLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  // 이제 useGroupPermissions는 GroupPermissionsProvider의 컨텍스트 내에서 호출됩니다.
  const { isLoading, isLeader, error } = useGroupPermissions()
...
// GroupLayout은 GroupPermissionsProvider를 제공하고, GroupLayoutContent를 자식으로 렌더링합니다.
